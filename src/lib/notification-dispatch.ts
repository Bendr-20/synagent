...
import { getDispatchConfig, type DispatchConfig } from "./notification-config";
import type { MatchNotification } from "@/lib/match-types";

export { getDispatchConfig } from "./notification-config";
